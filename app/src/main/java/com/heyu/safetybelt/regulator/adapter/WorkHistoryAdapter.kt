...
class WorkHistoryAdapter(private var workSessions: List<LCObject>) : RecyclerView.Adapter<WorkHistoryAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val alertCountText: TextView = view.findViewById(R.id.alert_count_text)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val alertCount = session.getInt("alertCount")
        ...
        holder.endTimeText.text = context.getString(R.string.work_history_end_time, endTime?.let { timeFormatter.format(it) } ?: "--:--")
        holder.alertCountText.text = context.getString(R.string.work_history_alert_count, alertCount)
